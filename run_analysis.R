...
#To get datafile and unzip the files
...
#Read the Train and Text subject files
...
dtSubject <- rbind(STrain, STest)
setnames(dtSubject, "V1", "subject")

dtActivity <- rbind(ATrain, ATest)
